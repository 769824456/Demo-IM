...
import io.rong.app.db.UserInfos;
...
public class UserInfosDao extends AbstractDao<UserInfos, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Portraits = new Property(3, String.class, "portraits", false, "PORTRAITS");
    ...
    protected void bindValues(SQLiteStatement stmt, UserInfos entity) {
        ...
        String portraits = entity.getPortraits();
        if (portraits != null) {
            stmt.bindString(4, portraits);
        }
    ...
    public UserInfos readEntity(Cursor cursor, int offset) {
        UserInfos entity = new UserInfos( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // portraits
    ...
    public void readEntity(Cursor cursor, UserInfos entity, int offset) {
        ...
        entity.setPortraits(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
